...
<svg viewBox="0 -3 32 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <g {stroke} stroke-width="4px" fill-rule="evenodd">
    <g transform="translate(-102.000000, -882.000000)" {fill}>
      <path
