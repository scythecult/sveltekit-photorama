...
type LayoutRouteId = RouteId | "/(hidden)/secret"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/(hidden)/+layout.server.js').load>>>>>>;
