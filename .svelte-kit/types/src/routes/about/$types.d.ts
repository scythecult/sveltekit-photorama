...
type LayoutRouteId = RouteId | "/about" | "/about/[slug]"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/about/+layout.server.js').load>>>>>>;
