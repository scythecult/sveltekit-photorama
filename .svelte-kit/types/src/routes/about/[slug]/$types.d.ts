...
type LayoutRouteId = RouteId | "/about/[slug]"
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/about/[slug]/+page.server.js').load>>>>>>;
